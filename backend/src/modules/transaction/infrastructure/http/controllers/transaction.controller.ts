...
export class TransactionController {
	...
	public async getSeveral(req: Request, res: Response, next: NextFunction) {
		...
		try {
			const transactionsList =
				await this.transactionService.findServeral({
					pagination: {
						limit: parsedLimit,
						offset: parsedOffset,
					},
	...
	public async getOne(req: Request, res: Response, next: NextFunction) {
		...
		try {
			const transactionFound = await this.transactionService.findById(
				id
			);
	...
	public async createOne(req: Request, res: Response, next: NextFunction) {
		...
		try {
			const transactionCreated =
				await this.transactionService.createOne(transactionData);
	...
	public async updateOneById(
		...
		try {
			const transactionUpdated =
				await this.transactionService.updateById(id, transactionData);
